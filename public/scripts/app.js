...
(function() {
  ...
  app.saveSelectedCities = function(){
    ...
    console.log("User prefernce: "+ localStorage.selectedCities)
  }
...
if(app.selectedCities){
  ...
  app.selectedCities.forEach(function(selectedCity){
    app.getForecast(selectedCity.key, selectedCity.label);
  })
}else{
